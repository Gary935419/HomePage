...
class Seminar extends Model
{
    ...
    public function search_S_SEMINARS_EXHIBITIONS($params)
    {
        try {
            ...
            if ((isset($params['D_FROM']) && $params['D_FROM'] != '') && (isset($params['D_TO']) && $params['D_TO'] != '')){
                $m_goods = $m_goods->whereBetween('exhibition_dates1', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates2', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates3', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates4', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates5', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates6', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates7', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates8', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates9', [$params['D_FROM'], $params['D_TO']])
                    ->orwhereBetween('exhibition_dates10', [$params['D_FROM'], $params['D_TO']]);
            }
            if ((isset($params['D_FROM']) && $params['D_FROM'] != '') && !(isset($params['D_TO']) && $params['D_TO'] != '')) {
