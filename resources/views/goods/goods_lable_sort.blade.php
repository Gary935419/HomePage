        ...
        $(function() {
            $('#submit_btn').click(function() {
                ...
                $.confirm({
                    ...
                    confirm: function() {
                        var url = "/api/goods/goods_lable_sort";
                        var params = {};
                        params.sortedIDs = sortedIDs;
                        ajax.post(url, params, function(data) {
                            if (data['RESULT'] == "OK") {
                                location.href = "/goods/goods_lablelists?msg_code=200&&msg="+'並び順設定が完了しました。';
                            } else {
                                location.href = "/goods/goods_lablelists?msg_code=201&&msg="+data['MESSAGE'];
                            }
                        });
                    },
                });
