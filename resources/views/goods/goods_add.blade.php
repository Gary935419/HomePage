            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form enctype="multipart/form-data" action="/goods/goods_regist" method="post" id="form">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">製品名</label>
                                    <input type="text" class="form-control" id="p_name" name="p_name" placeholder="製品名">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputFile">ロゴ画像</label>
                                    <div class="custom-file">
                                        <input type="hidden" name="p_logo" id="p_logo" class="custom-file-input">
                                        <label class="custom-file-label" for="customFile" id="upload_p_logo">ファイルを選択</label>
                                    </div>
                                    <img class="layui-upload-img" style="width:100px;height:100px;display: none;margin-top: 1%" id="p_logo_img" name="p_logo_img">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="hidden" name="p_main_img" id="p_main_img" class="custom-file-input">
                                        <label class="custom-file-label" for="customFile" id="upload_p_main_img">ファイルを選択</label>
                                    </div>
                                    <img class="layui-upload-img" style="width:100px;height:100px;display: none;margin-top: 1%" id="p_main_img_img" name="p_main_img_img">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="hidden" name="p_pdf_url" id="p_pdf_url" class="custom-file-input">
                                        <label class="custom-file-label" for="customFile" id="upload_p_pdf_url">ファイルを選択</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="p_video_url" name="p_video_url" placeholder="製品動画URL">
                                </div>
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="editor-container" style="width: 100%">
                                        <textarea class="form-control" rows="6" id="p_contents" name="p_contents" placeholder="製品説明"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" name="p_open_flg" id="p_open_flg" value="1">
