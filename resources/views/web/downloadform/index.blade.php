...
<body>
               ...
               <div class="contact_wrap">
                    ...
                    <div class="contact_inner">
                            <dl>
                                ...
                                <dd>
                                    <p class="pdf_list_link_wrap"><span class="pdf_list_link">{{$info_download['d_file_name'] ?? ''}}</span></p>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <div class="white_box03">
                                ...
                                その他の個人情報の取扱については、<a href="/web/privacy/">プライバシーポリシー</a>をご参照ください。</p>
                            </div>
    ...
    <script>
        ...
        function send_download() {
            var url = "/webapi/download/download_from_add";
            var params = {};
            params.id = $("#id").val();
            ...
            ajax.post(url, params, function(data) {
                if (data['RESULT'] === "OK") {
                    location.href = "/web/downloadform_thanks?id=" + $("#id").val() + "&&phone_number=" + $("#phone_number").val() + "&&email=" + $("#email").val();
                }else {
                    alert(alert['MESSAGE']);
                    return false;
                }
