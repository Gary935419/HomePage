                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header row">
                                <div class="col-6">
                                    <button style="width: 15%" type="button" onclick="location.href='/imports/lable_add'"
                                            class="btn btn-block btn-success">新規登録
                                    </button>
                                </div>
                                <div class="col-6 text-right">
                                    <button style="width:  18%;float: right" type="button" onclick="location.href='/imports/lable_sort'"
            ...
            $.confirm({
                ...
                confirm: function () {
                    ...
                    ajax.post(url, params, function(data) {
                        if (data['RESULT'] == "OK") {
                            location.href = "/imports/lable_lists?msg_code=200&&msg="+'タグ情報の削除が完了しました。';
                        } else {
                            location.href = "/imports/lable_lists?msg_code=201&&msg="+data['MESSAGE'];
                        }
                    });
                },
            });
