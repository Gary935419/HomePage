                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="search-form" action="/seminar/lable_lists" style="margin-bottom: 1%">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label>タグ名</label>
                                                <input type="text" value="{{ $s_name }}" placeholder="タグ名" name="s_name" class="form-control">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        function del(id, name) {
            $.confirm({
                title: false,
                theme: 'white',
                content: 'タグ名 ' + name + ' 削除するかどうか?',
                confirmButton: 'はい',
                cancelButton: 'いいえ',
                confirmButtonClass: 'btn-danger',
                cancelButtonClass: 'btn-info',
                confirm: function () {
                    var url = "/api/seminar/lable_delete";
                    var params = {};
                    params.id = id;

                    ajax.post(url, params, function(data) {
                        if (data['RESULT'] == "OK") {
                            location.href = "/seminar/lable_lists?msg_code=200&&msg="+'タグ情報の削除が完了しました。';
                        } else {
                            location.href = "/seminar/lable_lists?msg_code=201&&msg="+data['MESSAGE'];
                        }
                    });
                },
            });
