                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">密码修改 - {{$USER_ID}}</h3>
                            </div>
                            <!-- form start -->
                            <form class="form-horizontal" action='/userinfo/force_password_change' method='post'>
                                <div class="card-body">
                                ...
                                @if (isset($SEQ_NO))
                                    <input type="hidden" name="client_seq" value="{{$SEQ_NO}}">
                                @endif
                                <!-- /.card-footer -->
                            </form>
                        </div>
