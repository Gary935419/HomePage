                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">パスワードの有効期限が切れています。</h3>
                            </div>
                            <!-- form start -->
                            <form class="form-horizontal" action='/userinfo/password_change' method='post'>
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">アカウント</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">新しいパスワード</label>
                                        <div class="col-sm-10">
