...
Route::middleware(['req.trim'])->group(function () {
    Route::group(['prefix' => 'api'], function ($app) {
        ...
        $app->post('goods/goods_lable_sort', 'api\GoodsController@post_goods_lable_sort');
        $app->post('goods/goods_bannerdelete', 'api\GoodsController@post_goods_bannerdelete');
        $app->post('goods/goods_banner_sort', 'api\GoodsController@post_goods_banner_sort');
        $app->post('imports/recedents_delete', 'api\ImportsController@post_recedents_delete');
        $app->post('imports/recedents_sort', 'api\ImportsController@post_recedents_sort');
        $app->post('imports/company_delete', 'api\ImportsController@post_company_delete');
        $app->post('imports/company_sort', 'api\ImportsController@post_company_sort');
        $app->post('imports/lable_delete', 'api\ImportsController@post_lable_delete');
        $app->post('imports/lable_sort', 'api\ImportsController@post_lable_sort');
        $app->post('news/news_delete', 'api\NewsController@post_news_delete');
        $app->post('news/news_sort', 'api\NewsController@post_news_sort');
        $app->post('news/news_sorting', 'api\NewsController@post_news_sorting');
        $app->post('seminar/exhibition_delete', 'api\SeminarController@post_exhibition_delete');
        $app->post('seminar/exhibition_sort', 'api\SeminarController@post_exhibition_sort');
        $app->post('seminar/exhibition_sorting', 'api\SeminarController@post_exhibition_sorting');
        $app->post('seminar/teacher_delete', 'api\SeminarController@post_teacher_delete');
        $app->post('seminar/teacher_sort', 'api\SeminarController@post_teacher_sort');
        $app->post('seminar/lable_delete', 'api\SeminarController@post_lable_delete');
        $app->post('seminar/lable_sort', 'api\SeminarController@post_lable_sort');
        $app->post('management/site_delete', 'api\ManagementController@post_site_delete');
        $app->post('management/site_sort', 'api\ManagementController@post_site_sort');
        $app->post('download/file_delete', 'api\DownloadController@post_file_delete');
        $app->post('download/file_sort', 'api\DownloadController@post_file_sort');
        $app->post('download/category_delete', 'api\DownloadController@post_category_delete');
        $app->post('download/category_sort', 'api\DownloadController@post_category_sort');
    });
});
...
Route::middleware(['auth.admin','req.trim'])->group(function () {
    ...
    Route::group(['prefix' => 'goods'], function ($set) {
        ...
        $set->get('goods_sort', 'GoodsController@get_goods_sort');
        ...
        $set->get('goods_lable_sort', 'GoodsController@get_goods_lable_sort');
        ...
        $set->get('goods_banner_sort', 'GoodsController@get_goods_banner_sort');
    ...
    Route::group(['prefix' => 'imports'], function ($set) {
        ...
        $set->get('recedents_sort', 'ImportsController@get_recedents_sort');
        ...
        $set->get('company_sort', 'ImportsController@get_company_sort');
        ...
        $set->get('lable_sort', 'ImportsController@get_lable_sort');
    ...
    Route::group(['prefix' => 'news'], function ($set) {
        ...
        $set->get('news_sort', 'NewsController@get_news_sort');
    ...
    Route::group(['prefix' => 'seminar'], function ($set) {
        ...
        $set->get('exhibition_sort', 'SeminarController@get_exhibition_sort');
        ...
        $set->get('teacher_sort', 'SeminarController@get_teacher_sort');
        ...
        $set->get('lable_sort', 'SeminarController@get_lable_sort');
    ...
    Route::group(['prefix' => 'management'], function ($set) {
        ...
        $set->get('site_sort', 'ManagementController@get_site_sort');
    ...
    Route::group(['prefix' => 'download'], function ($set) {
        ...
        $set->get('file_sort', 'DownloadController@get_file_sort');
        ...
        $set->get('category_sort', 'DownloadController@get_category_sort');
